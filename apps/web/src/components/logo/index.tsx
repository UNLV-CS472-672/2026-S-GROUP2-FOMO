...
export const FomoLogo = ({
  ...
  const gradientId = 'fomo-logo-pin-gradient';
  const filterId = 'fomo-logo-heat-filter';
  return (
    <svg
      version="1.2"
    ...
    >
      ...
      <g style={{ transformBox: 'view-box', transformOrigin: 'center center' }}>
        <motion.g
          animate={{
